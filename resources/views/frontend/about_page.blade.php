                    ...
                    <div class="about__info__wrap">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="about" role="tabpanel" aria-labelledby="about-tab">
                                <p class="desc">{!!  $aboutSlide->long_description !!}</p>{{--  dobule !! use korle lekhar bitor class p tag use kora jay --}}
                                
                            </div>
                            <div class="tab-pane fade" id="skills" role="tabpanel" aria-labelledby="skills-tab">
                                <p class="desc">{!!  $aboutSlide->skills_description !!}</p>
                            </div>
                            <div class="tab-pane fade" id="awards" role="tabpanel" aria-labelledby="awards-tab">
                                <p class="desc">{!!  $aboutSlide->awards_description !!}</p>
                            </div>
                            <div class="tab-pane fade" id="education" role="tabpanel" aria-labelledby="education-tab">
                                <p class="desc">{!!  $aboutSlide->educations_description !!}</p>
                            </div>
                        </div>
                    </div>
                </div>
