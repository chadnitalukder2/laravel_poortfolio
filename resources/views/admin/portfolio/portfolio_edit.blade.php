                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('update.portfolio') }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input name="portfolio_name" value="{{ $portfolio->portfolio_name }}" class="form-control" type="text" id="example-text-input">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input name="portfolio_title" value="{{ $portfolio->portfolio_title }}"  class="form-control" type="text" id="example-text-input">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                <input name="portfolio_image" value="{{ asset( $portfolio->portfolio_image) }} class="form-control" type="file" id="image">
                                </div>
                            </div>
                            <!-- end row -->
